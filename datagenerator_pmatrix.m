function [pMatrix, muHat, sigmaHat, tauHat, pTauHat] = ...
    datagenerator_pmatrix(nVertex, nBlock, dimLatentPosition, B, rho, ...
...
if exist(['data/sim-dir-n' num2str(nVertex) '-diag' num2str(B(1, 1)) ...
        ...
        '-pmatrix' int2str(iProbMatrix) '.mat'], 'file') == 0
    ...
    xDirichlet = [];
    for iBlock = 1:nBlock
        xTmp = drchrnd(r*[nuStar(iBlock, :), 1 - sum(nuStar(iBlock, :))] + ...
    ...
    save(['data/sim-dir-n' num2str(nVertex) '-diag' num2str(B(1, 1)) ...
        '-offdiag' num2str(B(1, 2)) '-r' num2str(r) ...
        '-pmatrix' int2str(iProbMatrix) '.mat'],...
